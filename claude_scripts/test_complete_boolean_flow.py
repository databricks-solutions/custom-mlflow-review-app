...
def test_complete_boolean_flow():
  ...
  response = requests.post(
    f'{BASE_URL}/api/review-apps/{review_app_id}/schemas', json=schema_data, headers=headers
  )
  ...
  target_assessment = next(
    (a for a in assessments if a.get('assessment_id') == true_assessment_id), None
  )
  ...
  response = requests.delete(
    f'{BASE_URL}/api/review-apps/{review_app_id}/schemas/{schema_name}', headers=headers
  )
