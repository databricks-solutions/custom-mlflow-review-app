        ...
        <Card className="border-orange-200 bg-orange-50">
          <CardHeader>
            ...
            <CardDescription className="text-orange-700">
              Developer role required to access this page. You are currently logged in as an SME (Subject Matter Expert).
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-orange-800">
              This page is restricted to developers who can manage labeling sessions and configure the review app.
